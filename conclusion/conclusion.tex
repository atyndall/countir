...
As discussed in the \fref{subsec:classification}, the prototype developed achieves accuracies in the 80\% range for the K* and C4.5 machine learning algorithms.
...
As discussed in the Energy Efficiency results (\Fref{chap:evaluation}, \fref{subsec:energy}) % TODO more here
