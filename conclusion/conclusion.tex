...
The overlapping characteristics of the \mlx, discussed in more detail in \Fref{chap:evaluation}, \fref{subsec:sensitivity}, make several % TODO: Go further

the overlapping bell-curve characteristics of the \mlx's pixels, it may be possible to perform sub-pixel localization on objects within images. % TODO: Expand
