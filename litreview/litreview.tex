...
The first of these approaches is \cite{kleiminger2013occupancy}, which attempts to measure electricity consumption and use such data to determine Presence. % TODO Discuss more

The second of these approaches is \cite{ting2013occupancy}, which attempts to measure network traffic, among other things, to determine Presence. % TODO Discuss more
