...
\noindent Code included in this document is also released under the GNU General Public License v3, and can be found in its entirety at \url{https://github.com/atyndall/thing}.
