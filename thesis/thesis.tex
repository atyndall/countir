...
% Hyperref setup
\hypersetup{pdftitle=\thetitle,pdfauthor=\theauthor,pdfsubject=\thecategories,pdfkeywords=\thekeywords,hidelinks=true}
...
\begin{figure}
\centering
\includegraphics[height=0.85\textheight]{../diagrams/mlx-arduino.pdf}
\caption{MLX90620 and Arduino connecting circuit}
\label{fig:circuits:arduino2}
\end{figure}
