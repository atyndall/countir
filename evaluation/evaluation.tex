...
Additionally, in a real-world system, we contend that a sample rate of 0.0.1~Hz (once per 100 seconds) would provide sufficiently up-to-date information. Doing so provides an order of magnitude more battery life (``LowPwr B'' in \Fref{tab:lives}), with it being able to last more than 12~years.
