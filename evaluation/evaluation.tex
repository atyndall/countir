...
If we were to implement a simple software-driven sleep cycle (``Sleeping'' in \Fref{tab:lives}) minor power savings would occur. Incorporating sleep would reduce average current to 34~mA, assuming our present Arduino current draw. With the same battery capacity, we would expect battery life to increase to 12~days.
